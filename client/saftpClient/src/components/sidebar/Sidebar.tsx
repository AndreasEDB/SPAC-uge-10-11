...
const Sidebar = () => {
  const { sidebarComponent, sidebarTitle, closeSidebar, wide } =
  ...
  return (
    <>
      ...
      <aside
        className={[
          "fixed top-0 bottom-0 max-w-full bg-white shadow-2xl right-0 transition-transform duration-300 h-dvh pb-10",
          wide ? "w-[70rem]" : "w-[35rem]",
